      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex-shrink-0 flex items-center">
            <a href="/login">
              <img className="h-15 w-16 max-w-16"  src="https://raw.githubusercontent.com/raulgonca/Front_stafko/main/src/Image/Logito.png" alt="Logo" />
            </a>
          </div>
          {/* Search */}
          ...
          <div className="flex items-center">
            <div className="relative ml-3">
              <button className="max-w-xs bg-gray-800 mt-1 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu" aria-haspopup="true">
